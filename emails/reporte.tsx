...
interface PerimiecPeritajeProps {
...
export const PerimiecPeritaje = ({
  userFirstname,
  fecha,
  hora
}: PerimiecPeritajeProps) => (
  <Html>
    <Head />
    <Body style={main}>
...
PerimiecPeritaje.PreviewProps = {
  userFirstname: 'Alan',
} as PerimiecPeritajeProps;

export default PerimiecPeritaje;
